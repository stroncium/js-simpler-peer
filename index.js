 ...
 * when constructing a SimplerPeer.
 */
SimplerPeer.config = {
  iceServers: [
    {
...
SimplerPeer.channelConfig = {}

Object.defineProperty(SimplerPeer.prototype, 'bufferSize', {
  get: function () {
    var self = this
...
Object.defineProperty(SimplerPeer.prototype, 'connected', {
  get: function () {
    var self = this
...
SimplerPeer.prototype.address = function () {
  var self = this
  return { port: self.localPort, family: self.localFamily, address: self.localAddress }
}

SimplerPeer.prototype.signal = function (data) {
  var self = this
 ...
 */
SimplerPeer.prototype.send = function (chunk) {
  var self = this
 ...
 * @param {Object} init
 */
SimplerPeer.prototype.addTransceiver = function (kind, init) {
  var self = this
 ...
 * @param {MediaStream} stream
 */
SimplerPeer.prototype.replaceTrack = function (oldTrack, newTrack, stream) {
  var self = this
 ...
 * @param {MediaStream} stream
 */
SimplerPeer.prototype.removeTrack = function (track, stream) {
  var self = this
...
SimplerPeer.prototype._needsNegotiation = function () {
  var self = this
...
SimplerPeer.prototype.negotiate = function () {
  var self = this
...
SimplerPeer.prototype.destroy = function (err) {
  var self = this
  self._destroy(err, function () {})
}

SimplerPeer.prototype._destroy = function (err, cb) {
  var self = this
  if (self.destroyed) return
...
SimplerPeer.prototype._setupData = function (event) {
  var self = this
  if (!event.channel) {
...
SimplerPeer.prototype._read = function () {}

SimplerPeer.prototype._write = function (chunk, encoding, cb) {
  var self = this
...
// supported.
SimplerPeer.prototype._onFinish = function () {
  var self = this
  if (self.destroyed) return
...
SimplerPeer.prototype._startIceCompleteTimeout = function () {
  var self = this
  if (self.destroyed) return
...
SimplerPeer.prototype._createOffer = function () {
  var self = this
  if (self.destroyed) return
...
SimplerPeer.prototype._requestMissingTransceivers = function () {
  var self = this
...
SimplerPeer.prototype._createAnswer = function () {
  var self = this
  if (self.destroyed) return
...
SimplerPeer.prototype._onIceStateChange = function () {
  var self = this
  if (self.destroyed) return
...
SimplerPeer.prototype.getStats = function (cb) {
  var self = this
...
SimplerPeer.prototype._maybeReady = function () {
  var self = this
...
SimplerPeer.prototype._onInterval = function () {
  var self = this
...
SimplerPeer.prototype._onSignalingStateChange = function () {
  var self = this
  if (self.destroyed) return
...
SimplerPeer.prototype._onIceCandidate = function (event) {
  var self = this
  if (self.destroyed) return
...
SimplerPeer.prototype._onChannelMessage = function (event) {
  var self = this
  if (self.destroyed) return
  var data = event.data
...
SimplerPeer.prototype._onChannelBufferedAmountLow = function () {
  var self = this
...
SimplerPeer.prototype._onChannelClose = function () {
  var self = this
  if (self.destroyed) return
...
SimplerPeer.prototype._onTrack = function (event) {
  var self = this
  if (self.destroyed) return
